...
Link to [Notes](https://github.com/artmusic0/Documentation/Git Guide/)
...
Link to [Notes](https://github.com/artmusic0/Documentation/Learning Deep Learning and Application Notes/).
...
Link to [Notes](https://github.com/artmusic0/Documentation/Notes for Hadoop 1.2.1 install and build guide/).
